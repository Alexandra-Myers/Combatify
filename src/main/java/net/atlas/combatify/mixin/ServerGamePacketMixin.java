...
public abstract class ServerGamePacketMixin {
	...
	@Inject(method = "handlePickItem", at = @At(value = "INVOKE", target = "Lnet/minecraft/server/network/ServerGamePacketListenerImpl;send(Lnet/minecraft/network/protocol/Packet;)V", ordinal = 0))
	public void handlePickItem(ServerboundPickItemPacket serverboundPickItemPacket, CallbackInfo ci) {
