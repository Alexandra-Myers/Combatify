...
public abstract class NeoForgeHUDOverlayHandlerMixin {
	@SuppressWarnings({"UnresolvedMixinReference", "MixinAnnotationTarget"})
	@ModifyExpressionValue(method = "Lsqueek/appleskin/client/HudOverlayHandler;shouldShowEstimatedHealth(Lnet/minecraft/world/entity/player/Player;)Z", at = @At(value = "CONSTANT", args = "intValue=18"))
