...
public class PostBlockEffects {
	public static final LateBoundIdMapper<IdentifierUtils.@NotNull PseudoId, @NotNull MapCodec<? extends PostBlockEffect>> ID_MAPPER = new LateBoundIdMapper<>();
	public static final Codec<PostBlockEffect> CODEC = ID_MAPPER.codec(IdentifierUtils.PSEUDO_CODEC)
