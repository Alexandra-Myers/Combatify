...
public class BlockingTypeInit {
	public static final CombinedModifier COPPER_SHIELD_PROTECTION = CombinedModifier.createBaseOnly(new ComponentModifier(Component.translatable("attribute.modifier.equals." + AttributeModifier.Operation.ADD_VALUE.id(), Component.translatableWithFallback("attribute.name.shield_strength", "Shield Strength")), new AddValue(LevelBasedValue.constant(1.25F)), 1), Optional.empty());
