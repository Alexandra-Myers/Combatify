...
public class BlockingTypeInit {
	...
	public static final ComponentModifier NEW_SHIELD_KNOCKBACK = new ComponentModifier(Component.translatable("attribute.modifier.equals." + AttributeModifier.Operation.ADD_VALUE.id(), Component.translatable("attribute.name.generic.knockback_resistance")), new AddValue(LevelBasedValue.constant(0.25F)), Optional.empty(), 10);
