...
public record ShieldMaterial(Material base, Material baseNoPattern) {
	...
	public static final ShieldMaterial COPPER_SHIELD = new ShieldMaterial(new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.withDefaultNamespace("combatify/copper_shield_base")), new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.withDefaultNamespace("combatify/copper_shield_base_nopattern")));
