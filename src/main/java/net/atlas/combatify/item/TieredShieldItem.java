...
public class TieredShieldItem extends ShieldItem {
	...
	public static final DeferredItem<Item> IRON_SHIELD = registerItem("iron_shield", properties -> new TieredShieldItem(Tiers.IRON, properties, 0, 3, 3, Blocker.NEW_SHIELD, SHIELD_DAMAGE_FUNCTION), new Item.Properties());
	public static final DeferredItem<Item> GOLD_SHIELD = registerItem("golden_shield", properties -> new TieredShieldItem(Tiers.GOLD, properties, -0.2F, 1, 4, Blocker.NEW_SHIELD, GOLDEN_SHIELD_DAMAGE_FUNCTION), new Item.Properties());
	public static final DeferredItem<Item> DIAMOND_SHIELD = registerItem("diamond_shield", properties -> new TieredShieldItem(Tiers.DIAMOND, properties, 0, 5, 2, Blocker.NEW_SHIELD, SHIELD_DAMAGE_FUNCTION),new Item.Properties());
	public static final DeferredItem<Item> NETHERITE_SHIELD = registerItem("netherite_shield", properties -> new TieredShieldItem(Tiers.NETHERITE, properties, 0, 5, 2, Blocker.NEW_SHIELD.withKnockback(Collections.singletonList(BlockingTypeInit.SHIELD_KNOCKBACK)).withProtection(Collections.singletonList(BlockingTypeInit.NETHERITE_SHIELD_PROTECTION)), SHIELD_DAMAGE_FUNCTION), new Item.Properties().fireResistant());
