...
public class ItemRegistry {
	...
	public static final Item WOODEN_LONGSWORD = registerItem(id("wooden_longsword"), properties -> new LongSwordItem(ToolMaterial.WOOD, properties), new Item.Properties());
	...
	public static final Item STONE_LONGSWORD = registerItem(id("stone_longsword"), properties -> new LongSwordItem(ToolMaterial.STONE, properties), new Item.Properties());
	...
	public static final Item IRON_LONGSWORD = registerItem(id("iron_longsword"), properties -> new LongSwordItem(ToolMaterial.IRON, properties), new Item.Properties());
	...
	public static final Item GOLD_LONGSWORD = registerItem(id("golden_longsword"), properties -> new LongSwordItem(ToolMaterial.GOLD, properties), new Item.Properties());
	...
	public static final Item DIAMOND_LONGSWORD = registerItem(id("diamond_longsword"), properties -> new LongSwordItem(ToolMaterial.DIAMOND, properties), new Item.Properties());
	...
	public static final Item NETHERITE_LONGSWORD = registerItem(id("netherite_longsword"), properties -> new LongSwordItem(ToolMaterial.NETHERITE, properties), new Item.Properties().fireResistant());
