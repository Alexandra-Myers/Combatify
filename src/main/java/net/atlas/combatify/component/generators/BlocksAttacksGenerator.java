...
public record BlocksAttacksGenerator(Optional<Float> blockDelaySeconds,
	...
	public void patchDataComponentMap(Item item, PatchedDataComponentMap patchedDataComponentMap) {
		ExtendedBlockingData original = patchedDataComponentMap.get(CustomDataComponents.EXTENDED_BLOCKING_DATA);
		if (original != null) {
			...
			patchedDataComponentMap.set(CustomDataComponents.EXTENDED_BLOCKING_DATA, original.withBlocksAttacks(blockDelaySeconds.orElse(original.baseBlocksAttacks().useSeconds()),
			...
			patchedDataComponentMap.set(CustomDataComponents.EXTENDED_BLOCKING_DATA, ExtendedBlockingData.VANILLA_SHIELD.withBlocksAttacks(blockDelaySeconds.orElse(1F),
