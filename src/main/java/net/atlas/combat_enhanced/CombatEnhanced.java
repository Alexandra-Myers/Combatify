...
import net.atlas.combat_enhanced.enchantment.DefendingEnchantment;
import net.atlas.combat_enhanced.enchantment.PiercingEnchantment;
import net.atlas.combat_enhanced.extensions.ItemExtensions;
import net.atlas.combat_enhanced.item.ItemRegistry;
import net.atlas.combat_enhanced.networking.NetworkingHandler;
...
public class CombatEnhanced implements ModInitializer {
	public static Player player;
	public static final String MOD_ID = "combat_enhanced";
	public static final CombatEnhancedConfig CONFIG = CombatEnhancedConfig.createAndLoad();
