...
public class NewAttributes extends Attributes{
	...
	public static final Attribute ATTACK_REACH = register("generic.attack_reach", (new RangedAttribute("attribute.name.generic.attack_reach", 6.0, 0.0, 1024.0)).setSyncable(true));
}
